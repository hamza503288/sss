...
BEGIN
    ...
    IF create_monthly_table('table_terme_test_debug') THEN
        RAISE NOTICE 'Test de création réussi';
        
        -- Insérer une donnée de test
        INSERT INTO table_terme_test_debug (numero_contrat, prime, assure, echeance)
        VALUES ('TEST001', 1500.00, 'Test Assuré', '2025-12-31');
        
        RAISE NOTICE 'Test d''insertion réussi';
        
        -- Nettoyer la table de test
        DROP TABLE table_terme_test_debug;
        RAISE NOTICE 'Nettoyage terminé';
    ELSE
        RAISE NOTICE 'Échec du test de création';
    END IF;
END $$;